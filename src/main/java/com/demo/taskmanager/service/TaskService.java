...
public interface TaskService {
    TaskDto.Response createTask(
        TaskDto.Request request, String token); // ← add token
    TaskDto.Response getTaskById(Long id);
    List<TaskDto.Response> getAllTasks();
    TaskDto.Response updateTask(
        Long id, TaskDto.Request request);
    TaskDto.Response updateTaskStatus(
        Long id, TaskDto.StatusUpdate statusUpdate);
    ...
    AuthUserDto getCurrentUser(String token); // ← add this
}